...
import { advanceStateStocks, computeAgricultureStep, computeCapitalStep, computeCrossSectorStep, computeMortalityAndBirthStep, computePollutionStep, computePopulationFeedbackStep, computePopulationLeadingStep, computeResourceStep, } from "./world3-simulation-sectors.js";
...
export function simulateWorld3(options) {
    ...
    function computeStep(k) {
        ...
        const populationLeading = computePopulationLeadingStep(k, t, buffers, constants, lookups, integrators, iphst);
        const capitalState = computeCapitalStep(k, t, buffers, constants, lookups, integrators, pyear);
        const agricultureState = computeAgricultureStep(k, t, buffers, constants, lookups, integrators, pyear);
        const pollutionState = computePollutionStep(k, t, buffers, constants, lookups, integrators, pyear);
        const resourceState = computeResourceStep(k, t, buffers, constants, lookups, pyear);
        const crossSectorState = computeCrossSectorStep(k, t, buffers, constants, lookups, capitalState, agricultureState, resourceState, pyear);
        computePopulationFeedbackStep(k, t, buffers, constants, lookups, populationLeading, agricultureState, pollutionState, crossSectorState, pyear);
