...
export function createRuntimeStateFrame(prepared, fixture) {
    ...
    populateCapitalNativeSupportSeries(sourceFrame, sourceSeries, prepared, constantsUsed, capitalCapabilities.canUseNativeCapitalAllocation, capitalCapabilities.canUseNativeCapitalInvestment, capitalCapabilities.canUseNativeCapitalStocks, capitalCapabilities.canUseNativeCapitalVisibleOutputFormulas);
